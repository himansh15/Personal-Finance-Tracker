...
const AddIncomeForm = ({ onAddIncome }) => {
  ...
  const handleReceiptUpload = async (e) => {
    ...
    try {
      ...
      if (source) handleChange("source", source);
  ...
  return (
    <div>
      ...
      <div className="my-4">
        <label className="block mb-2 font-semibold">Upload Receipt (optional)</label>
        <input 
          type="file" 
          accept="image/*" 
        ...
        />
        {isScanning && <p className="text-blue-500 mt-2">Scanning receipt...</p>}
      </div>
